...
public class BccTest extends TestCase {
    ...
    public void testAddMultipleBcc() throws EmailException {
		System.out.println("Test adding multiple BCC addresses. This shows that multiple addresses are added to the 
        Bcc list using the addBcc(String...emails) method. - by zwp___");
